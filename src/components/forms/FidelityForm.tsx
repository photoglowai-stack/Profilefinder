  ...
  return (
    <div className="bg-white relative rounded-[32px] shadow-[0px_8px_24px_0px_rgba(0,0,0,0.12)] border border-gray-100 w-full max-w-2xl mx-auto min-h-[500px] p-6 md:p-10 backdrop-blur-sm">
      ...
      <motion.button
        ...
        className={`relative w-full md:w-fit md:min-w-[220px] box-border overflow-hidden flex items-center justify-center px-10 py-3 rounded-full transition-all shadow-lg ${screenshots.length > 0 && !isSearching
