...
export function ServiceButton({
  ...
  return (
    <motion.button
      onClick={onClick}
      disabled={disabled}
      className={`relative box-border content-stretch flex items-center justify-center px-[48px] md:px-[72px] py-[8px] rounded-[9999px] shrink-0 transition-all shadow-lg ${!disabled && !isSearching
